...
function cardsCreate(array) {
    let div;
    mixArrey(array);
    let parent_el = document.querySelector('.adjectgender-words')
    ...
    array.forEach((attrs) => {
        ...
        div.classList.add('adjectgender-words-block');
...
if (document.title === 'Adjective gender (restaurant)') {
    document.addEventListener("DOMContentLoaded", cardsCreate(adjectGenderRest))
