class ItcModal {
  ...
  #handlerCloseModal(e) {
    if (e.target.closest('.itc-modal-btn-close') || e.target.classList.contains('itc-modal-backdrop') || e.target.closest('.modal-btn-close')) {  /* Добавила последнее или, для кнопики Закрыть в футере модального окна */
      this.hide();
    }
  }
